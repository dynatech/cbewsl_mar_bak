        ...
        <Grid container>
          ...
          >
            ...
            {location.state.municipalResponse !== "" && (
              <Typography variant="subtitle1">
                <b>For the Municipal:</b> {location.state.municipalResponse}
              </Typography>
            )}
            {location.state.provincialResponse !== "" && (
              <Typography variant="subtitle1">
                <b>For the Provincial:</b> {location.state.provincialResponse}
              </Typography>
            )}
            <Typography variant="subtitle1" style={{ marginTop: 20 }}>
              <b>NOTE:</b> This bulletin contains the official Alert Level and
              Recommended Response of the Bakun MDRRMO for{" "}
              {CBEWSL_SITE_LOCATION} and will hold true until a new bulletin is
              released.
            </Typography>
          </Grid>
        </Grid>

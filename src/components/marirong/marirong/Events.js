...
import {
  getEvents,
  deleteEvent,
} from "../../marirong/marirong_apis/EventsManagement";
          ...
          <Fragment>
            ...
            <Modal open={viewModal}>
              <Box sx={modalStyle}>
                ...
                <Typography sx={{ mt: 2 }}>
                  <b>Activity name:</b>&nbsp;{calendarEvent.title}
                  <br />
                  <b>Activity place:</b>&nbsp;{calendarEvent.place}
                  <br />
                  <b>Activity note:</b>&nbsp;{calendarEvent.note}
                  <br />
                </Typography>
              </Box>
            </Modal>

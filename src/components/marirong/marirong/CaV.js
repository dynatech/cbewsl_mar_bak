...
import {
  ...
  getChildren,
  getToddler,
} from "../../marirong/marirong_apis/CapacityAndVulnerability";
  ...
  const handleSubmit = () => {
    ...
    householdMembers.map((item) => {
      ...
      tempMembers.push({
        ...
        disability: item.disabled
          ? item.disability == null
            ? "not specified"
            : item.disability
          : null,
        comorbidity: item.comorbid
          ? item.comorbidity == null
            ? "not specified"
            : item.comorbidity
          : null,
      });
    ...
    let submitData = {
      ...
      disability: householdHead.disabled
        ? householdHead.disability == null
          ? "not specified"
          : householdHead.disability
        : null,
      comorbidity: householdHead.comorbid
        ? householdHead.comorbidity == null
          ? "not specified"
    ...
    <Container>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            {listDisplay == "pregnant"
              ? "pregnant woman"
              : listDisplay == "disabled"
              ? "PWD/s "
              : listDisplay == "comorbid"
              ? "person/s with comorbidity"
              : listDisplay == "senior"
              ? "Senior Citizens"
              : listDisplay == "children"
              ? "Childrens (Ages 6 to 12)"
              : listDisplay == "toddler"
              ? "Childrens (Ages 0 to 5"
              : ""}
          </DialogContentText>
          <FabMuiTable
            data={{
      ...
      >
        <DialogTitle id="form-dialog-title">
          {action == "add" ? "Add New Household" : "Edit Household"}
        </DialogTitle>

...
const MarirongHeader = () => {
  ...
  useEffect(() => {
    ...
    const profile_picture =
      parse_data.profile.pic_path !== ""
        ? `${STORAGE_URL}/${parse_data.profile.pic_path}`
        : "";
  ...
  const handleCurrentTab = () => {
    ...
    if (path_name === "/opcen") {
      setValue(0);
    } else if (path_name === "/hazard_mapping" || path_name === "/cav") {
      setValue(1);
    } else if (
      path_name === "/analysis" ||
      path_name === "/rainfall" ||
      ...
      setValue(2);
    } else if (path_name === "/surficial_markers" || path_name === "/moms") {
      setValue(3);
